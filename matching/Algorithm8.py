...
def algo8(students,capacity,reserves,priority):
    ...
    g_prime.build_rrg()
    edge_copy = copy.deepcopy(g_prime.edges)
...
def example_1():
    ...
    sel,r1_seats,r2_seats = algo8(all_students,cap,all_reserves,plist)
    sel.sort()
    print(f"Algo 8 selected students: {sel}")
