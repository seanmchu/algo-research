...
def algo5(students,capacity,priority,reserves):
    #Change input so that we get reserves 
...
def example_1():
    ...
    sel,r1_seats,r2_seats = algo5(all_students,cap,plist,all_reserves,)
    sel.sort()
    print(f"Algorithm 5 selected students: {sel}")
